  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(() =>
      Effect.gen(function* () {
        ...
        const originalModelsDev = yield* modelsDevSvc.get()
        const geminiBase = {
          id: "gemini",
          name: "Gemini",
          env: [],
        ...
        const googleSourceModels = {
          ...(originalModelsDev.google?.models || {}),
          ...(originalModelsDev.gemini?.models || {})
        }
        ...
        const modelsDev = {
          ...
          "gemini-4": {
            ...geminiBase,
            id: "gemini-4",
            name: "Gemini (Account 4)"
          },
          "gemini-5": {
            ...geminiBase,
            id: "gemini-5",
            name: "Gemini (Account 5)"
          }
        } as any
